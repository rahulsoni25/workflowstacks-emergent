...
// rewrite_score is an LLM judge's 0-10 rating of the quality of OUR
// plain-English guide/listing for the skill — how clear, specific and useful
// the rewritten title, description and use_guide are. It is NOT a measure of
// the upstream repository's maintenance, safety or "health" (that lives in
// codeflow signals: pushed_at, license, dead_repo). It was previously shown to
// visitors as "Health Score", which invited exactly that misreading; every
// surface now labels it as guide quality.
export function guideScore(s) {
  return typeof s?.rewrite_score === 'number' ? s.rewrite_score : null
}
// Back-compat alias for any external importer; prefer guideScore.
export const healthScore = guideScore
