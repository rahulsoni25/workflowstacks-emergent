...
export function homeFaqs() {
  return [
    ...
    },
    {
      ...
      a: 'Yes. Install hands you a system prompt formatted for Claude, ChatGPT or Gemini. Paste it as a project, custom GPT or Gem instruction. Nothing to install and no code — a few tools need their own API key, and the listing says so up front.',
    },
    {
      q: 'Do I need to code?',
