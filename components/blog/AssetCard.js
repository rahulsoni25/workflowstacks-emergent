...
export default function AssetCard({ asset, campaign }) {
  ...
  return (
    <div className="rounded-xl border border-[#262B2D] bg-[#101314] p-5">
      ...
      <div className="mt-1.5 text-[15px] font-semibold text-text-primary">{asset.label}</div>
      <Link
        href={href}
      ...
      <div className="mt-4 border-t border-[#262B2D] pt-3 text-[12.5px] text-text-muted">
