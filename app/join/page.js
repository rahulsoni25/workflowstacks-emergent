    ...
    <div className="min-h-screen bg-neptune">
      <header className="border-b border-teal-500/10 bg-slate-950/80 backdrop-blur-xl">
        <div className="container mx-auto px-4 py-4">
          <Link href="/members"><Button variant="ghost" className="text-text-secondary hover:text-white hover:bg-white/5"><ArrowLeft className="w-4 h-4 mr-2" />Members</Button></Link>
        </div>
      </header>
        ...
        {status === 'done' ? (
          <Card className="bg-slate-900/60 border-teal-500/30">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-text-muted mb-8">You're now part of the global AI Builder Network. Invite a few peers — the network grows by who you bring.</p>
          ...
          <>
            <div className="text-center mb-8">
              ...
              <p className="text-text-muted">Get featured among AI micro-SaaS founders, developers, influencers & indie hackers worldwide. Free.</p>
            ...
            <Card className="bg-slate-900/60 border-slate-700/50">
              <CardContent className="py-6">
                <form onSubmit={submit} className="space-y-4">
                  ...
                  <div>
                    <label className="text-sm text-text-secondary mb-1 block flex items-center gap-1.5"><Linkedin className="w-4 h-4 text-sky-400" />LinkedIn profile URL *</label>
                  ...
                  <div>
                    <label className="text-sm text-text-secondary mb-1 block">I'm a…</label>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-sm text-text-secondary mb-1 block flex items-center gap-1"><Globe className="w-3.5 h-3.5" />Country</label>
                      <Input value={form.country} onChange={set('country')} placeholder="India" className="bg-slate-800/50 border-slate-700 text-white" />
                    </div>
                    <div>
                      <label className="text-sm text-text-secondary mb-1 block">What you build with AI</label>
                  ...
                  <p className="text-center text-xs text-text-muted">No account or password. We list your name, role, country & LinkedIn.</p>
                </form>
              </CardContent>
            </Card>
          </>
