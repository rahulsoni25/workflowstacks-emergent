  ...
  return (
    <div className="min-h-screen bg-neptune">
      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <p className="text-lg text-text-secondary mb-4">{o.pain}</p>
        <p className="text-lg text-text-secondary mb-10">{o.how}</p>
          ...
          <Card className="bg-[#C6F24E]/10 border-[#C6F24E]/40 mb-12">
            <CardContent className="py-6 flex flex-wrap items-center justify-between gap-4">
              <div>
                ...
                <p className="text-text-muted text-sm mt-1 max-w-md">{tpl.outcome}</p>
              </div>
          ...
          <CardContent className="py-6 flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-text-muted text-sm">We’ll set this up in your tools, customized, running within 7 days.</p>
              </div>
            </div>
