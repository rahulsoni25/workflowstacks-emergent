            ...
            <CardContent className="py-8">
              <form onSubmit={submit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="dfy-name" className="block text-sm text-text-secondary mb-1.5">Your name</label>
                  ...
                  <div>
                    <label htmlFor="dfy-email" className="block text-sm text-text-secondary mb-1.5">Email</label>
                ...
                <div>
                  <label htmlFor="dfy-goal" className="block text-sm text-text-secondary mb-1.5">What do you want automated?</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="dfy-tools" className="block text-sm text-text-secondary mb-1.5">Tools you already use <span className="text-text-muted">(optional)</span></label>
                    <input id="dfy-tools" value={form.tools} onChange={set('tools')}
                      className="w-full bg-slate-950/60 border border-slate-700 rounded-md px-3 py-2.5 text-white text-sm focus:border-[#C6F24E]/60 focus:outline-none"
                      placeholder="Shopify, Gmail, Slack, Notion…" />
                  </div>
                  <div>
                    <label htmlFor="dfy-budget" className="block text-sm text-text-secondary mb-1.5">Budget <span className="text-text-muted">(optional)</span></label>
