...
export default function ProblemsClient({ initialProblems = [] }) {
  ...
  // Server seeds the list; only refetch if it came back empty.
  useEffect(() => { if (!initialProblems.length) load() }, [])
