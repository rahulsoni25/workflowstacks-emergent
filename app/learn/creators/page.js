  ...
  return (
    <div className="min-h-screen bg-neptune">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <p className="text-xl text-slate-300 text-center mb-16 max-w-2xl mx-auto">Share your AI skills with our launch audience and client network. Get discovered, build reputation, and earn.</p>
