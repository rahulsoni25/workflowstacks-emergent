        ...
        <div className="space-y-8">
          <Card className="bg-slate-900/60 border-slate-700/50">
            <CardContent className="py-6">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">Before MCP, every AI tool had its own proprietary way to connect to external services. MCP standardizes this into one protocol that works across Claude, ChatGPT, Gemini, and any LLM.</p>
              <p className="text-text-secondary leading-relaxed">Think of it like USB for AI — one standard connector that works with everything.</p>
            </CardContent>
          </Card>
