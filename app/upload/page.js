    ...
    <div className="min-h-screen bg-gradient-to-br neptune">
      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary">Share your AI skill with the community</p>
        </div>
        ...
        <Card className="bg-slate-900/60 border-slate-700/50 backdrop-blur-xl">
          <CardHeader>
            ...
            <CardDescription className="text-text-muted">
              Fill in the information about your skill. <Link href="/help" className="text-teal-400 underline">Need help?</Link>
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-text-muted text-sm">Give it a clear, descriptive name</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-slate-800/50 border-slate-700/50 text-white placeholder:text-text-muted min-h-[100px]"
                  placeholder="Example: Helps create engaging email campaigns with subject lines, body copy, and call-to-actions that convert"
                />
                <p className="text-text-muted text-sm">Explain what this skill does in 1-2 sentences</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-text-muted text-sm">Pick the closest match</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-text-muted text-sm">Leave as 0 to make it free</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-text-muted text-sm">So others know who created this skill</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-text-muted text-sm">Link to code repository if you have one</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-text-muted text-sm">Link to documentation or your website</p>
              </div>
