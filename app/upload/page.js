    ...
    <div className="min-h-screen bg-gradient-to-br neptune">
      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300">Share your AI skill with the community</p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-slate-500 text-sm">Give it a clear, descriptive name</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-slate-500 text-sm">Explain what this skill does in 1-2 sentences</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-slate-500 text-sm">Pick the closest match</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-slate-500 text-sm">Leave as 0 to make it free</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-slate-500 text-sm">So others know who created this skill</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-slate-500 text-sm">Link to code repository if you have one</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-slate-500 text-sm">Link to documentation or your website</p>
              </div>
