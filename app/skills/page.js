...
import { Search, Star, Download, Github, ArrowLeft, ChevronRight } from 'lucide-react'
...
const CATEGORIES = [
  'all', 'ai-agent', 'marketing', 'sales', 'saas-starter',
  'mcp-server', 'claude-skill', 'prompt', 'automation', 'analytics', 'support', 'design'
]
    ...
    <div className="min-h-screen bg-neptune">
      <header className="border-b border-teal-500/10 bg-slate-950/80 backdrop-blur-xl sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <span className="text-slate-400 text-sm">{skills.length} skills</span>
        </div>
      </header>
