      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-text-secondary leading-relaxed">We collect minimal data necessary to provide the Service:</p>
          ...
          <section>
            ...
            <p className="text-text-secondary leading-relaxed">Your data is stored securely on encrypted servers. Agent blueprints are generated on-demand and not permanently stored unless you explicitly save them.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-text-secondary leading-relaxed">You may request access to, correction of, or deletion of your personal data at any time by contacting privacy@workflowstacks.com.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white mb-3">7. Contact</h2>
            <p className="text-text-secondary leading-relaxed">For privacy inquiries, contact privacy@workflowstacks.com.</p>
          </section>
        </div>
      </div>
    </div>
